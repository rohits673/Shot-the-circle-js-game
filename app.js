const setTimer = document.getElementById("setTime"), //Get input time from user
  radioGrid = document.querySelector("#grid"), //Grid for creating 6*10 radio buttons matrix
  scoreBox = document.querySelector("#score"), //Score keeper box
  scoreOverlay = document.querySelector(".scoreboard"), //Overlay after game ends
